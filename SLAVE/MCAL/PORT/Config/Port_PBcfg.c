...
const Port_ConfigType Port_ConfigSet[] = {
     ...
     PortConf_PORTF_NUM,PortConf_Pin0_CHANNEL_NUM,PORT_PIN_IN,RESISTOR_OFF,PortConf_PortF_Pin0_Mode,PORT_PIN_DIGITAL,PORT_PIN_CHANGEABLE,PORT_MODE_UNCHANGEABLE,OPEN_DRAIN_DISABLE,STD_LOW,
     ...
     PortConf_PORTF_NUM,PortConf_Pin4_CHANNEL_NUM,PORT_PIN_IN,RESISTOR_OFF,PortConf_PortF_Pin4_Mode,PORT_PIN_DIGITAL,PORT_PIN_CHANGEABLE,PORT_MODE_UNCHANGEABLE,OPEN_DRAIN_DISABLE,STD_LOW
				         };
